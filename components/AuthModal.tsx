...
const AuthModal: FunctionComponent = () => {
    ...
    return (
        <motion.div initial="hidden" animate="show" className="relative z-50">
            <motion.div
                variants={background}
            ...
            <motion.div
                ...
                style={{ willChange }}
            >
                <div className="relative w-full max-w-sm rounded-xl p-8 pb-4 bg-carbon-gold border border-carbon-bronze/20">
                    ...
                    <Form view={view} setView={setView} emailRef={emailRef} />
